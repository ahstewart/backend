...
def update_model_version_config(
    ...
    if version.is_system_generated:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="This pipeline was auto-generated by the system and cannot be modified."
        )
...
def delete_model_version(
    ...
    if version.is_system_generated:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="This pipeline was auto-generated by the system and cannot be deleted."
        )
...
def trigger_pipeline_generation(
    ...
    if version.is_system_generated:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="This pipeline was auto-generated by the system and cannot be regenerated."
        )
